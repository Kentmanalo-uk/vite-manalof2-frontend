      ...
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white flex flex-col items-center justify-center px-6 py-24 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-8 max-w-5xl mb-12 w-full">
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-6 text-center">
              <p className="text-gray-100 text-sm md:text-lg leading-relaxed">
                Meet the 2030 NovaDrive X1 — a sleek, all-electric hypercar with
                AI-assisted navigation, self-healing body panels, and
                zero-emission performance. Designed for speed, safety, and
                sustainability.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-6 text-center">
              <p className="text-gray-100 text-sm md:text-lg leading-relaxed">
                A timeless 1930s luxury sedan — handcrafted elegance, chrome
                details, and whitewall tires. A rolling masterpiece of classic
                engineering and old-world charm.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Modal */}
        <Mod show={showModal} onClose={() => setShowModal(false)} />
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                Car-ris Corporation is a forward-thinking company dedicated to
                delivering innovative, reliable, and customer-focused solutions in
                the automotive industry. With a commitment to excellence,
                integrity, and sustainability, we strive to redefine mobility and
                enhance the driving experience for individuals and businesses
                alike. <br />
                <br /> Driven by passion and powered by expertise, Car-ris
                Corporation is your trusted partner on the road ahead.
              </p>
            </div>
            <div
              ref={aboutImageRef}
        ...
        <section id="customer-care" className="max-w-6xl mt-32">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                At Car-ris Corporation, our customers come first — always. Our
                dedicated Customer Care team is here to support you every step of
                the way, whether you have questions about your vehicle, need
                assistance with a service request, or simply want to share
                feedback. <br />
                <br /> We believe great service doesn’t end at the sale — it
                begins the moment you choose us. Reach out anytime. We’re ready to
                help, listen, and go the extra mile for you.
              </p>
            </div>
            <div
              ref={careImageRef}
